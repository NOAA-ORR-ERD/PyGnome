...
public:
	...
	OSErr				get_move(int n, unsigned long model_time, unsigned long step_len, WorldPoint3D* ref, WorldPoint3D* delta, double* rise_velocity, double* density, long* droplet_size, short* LE_status, LEType spillType, long spill_ID);
