...
OSErr DLL_API emulsify(int n, unsigned long step_len, double *frac_water, double *le_interfacial_area, double *frac_evap, double *droplet_diameter, long *age, double *bulltime, double k_emul, double emul_time, double emul_C, double S_max, double Y_max, double drop_max);
