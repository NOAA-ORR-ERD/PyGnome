...
public:
	...
	OSErr				get_move(int n, unsigned long model_time, unsigned long step_len, WorldPoint3D* ref, WorldPoint3D* delta, double* windage, LEStatus* LE_status, LEType spillType);
};
