...
class ShallowDepthGOR(object):
    ...
    def Calculate(self, depth, gas_oil_ratio,
        ...
        if oil_jet_velocity and oil_jet_density:
            ...
            raise 'need either oil_jet_velocity and oil_jet_density, or source_pressure'
        ...
        #   Roughly, each 10 meters (33 ft) of depth adds another bar to the ambient pressure
        #   Assuming the density of sea water to be 1025 kg/m^3 (in fact it is slightly variable),
...
if __name__ == '__main__':
    ...
    #
    # For our initial values, we will choose the ones that Debra came up with in her
    # matlab calculations (filename: GORatDepth.m)
    depth = 30 # depth in meters
    gasOilRatio = 2530 # gas/oil ratio at sealevel (S m^3/ S m^3)
    ...
    res = gor_at_depth.Calculate(depth, gasOilRatio, oilJetVelocity, oilJetDensity)
    print res
