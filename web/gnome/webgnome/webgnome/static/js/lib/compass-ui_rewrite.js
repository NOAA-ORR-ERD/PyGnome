...
(function($) {
    ...
    // Public compassUI API methods
    var methods = {
        // The plugin constructor
        init: function(options) {
            return this.each(function() {
                return new CompassUI(options);
            });
        },
    ...
    // Declare the jQuery UI plugin `compassUI`
    $.fn.compassUI = function(options) {
        if (methods[options]) {
            ...
            $.error('Method ' + options + ' does not exist on compassUI');
            return null;
        }
    };


    // CompassUI is a single instance of a compass display
    function CompassUI(options) {
        ...
        $(this.frontcanv).mousedown(this.onMousedown);
        $(this.frontcanv).mousemove(this.onmousemove);
        $(this.frontcanv).mouseup(this.onMouseup);
    }
