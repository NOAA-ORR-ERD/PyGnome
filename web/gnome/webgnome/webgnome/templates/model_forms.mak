...
<%include file="forms/add_spill.mak" args="form=add_spill_form"/>
...
<%include file="forms/point_release_spill.mak" args="form=point_release_spill_form, action_url=point_release_spill_form_url"/>
