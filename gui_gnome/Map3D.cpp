...
long Map3D_c::CheckSurroundingPoints(LONGH maskH, long numRows, long numCols, long row, long col) 
{
...
Boolean Map3D_c::ThereIsAdjacentLand2(LONGH maskH, DOUBLEH landMaskH, long numRows, long numCols, long row, long col) 
{
	long i, j, iStart, iEnd, jStart, jEnd, lowestLandIndex = 0;
	long neighbor;
...
Boolean Map3D_c::InteriorLandPoint(LONGH maskH, long numRows, long numCols, long row, long col) 
{
...
Boolean Map3D_c::ThereIsALowerLandNeighbor(LONGH maskH, long *lowerPolyNum, long numRows, long numCols, long row, long col) 
{
...
void Map3D_c::ResetMaskValues(LONGH maskH,long landBlockToMerge,long landBlockToJoin, long numRows, long numCols)
...
OSErr Map3D_c::SetUpCurvilinearGrid(char *path,DOUBLEH landMaskH, long numRows, long numCols, WORLDPOINTFH vertexPtsH, FLOATH depthPtsH, char* errmsg)
{
...
setFields:	
	...
	{
		if(!errmsg[0])
			strcpy(errmsg,"An error occurred in Map3D::ReorderPoints");
		printError(errmsg); 
...
OSErr Map3D_c::SetUpTriangleGrid2(char *path, long numNodes, long ntri, WORLDPOINTFH vertexPtsH, FLOATH depthPtsH, long *bndry_indices, long *bndry_nums, long *bndry_type, long numBoundaryPts, long *tri_verts, long *tri_neighbors) 
{
	OSErr err = 0;
	char errmsg[256];
