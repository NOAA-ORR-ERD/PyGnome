...
#define		kMatrixCode				0		// code to request units in matrix coordinates
#define		kRatioCode				1		// code to request a 1:N ratio from Get-Map-View-Width routine
#define		kMilesCode				2		// code to request a width in miles
#define		kInchesCode				3		// code to request a width in inches
