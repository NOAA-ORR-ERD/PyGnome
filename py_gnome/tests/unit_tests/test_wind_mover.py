...
def test_read_file_init():
    ...
    wind_ts = wind.get_timeseries(ts_format=basic_types.ts_format.uv, units='meter per second')
    ...
    wind_ts = wind.get_timeseries(ts_format=basic_types.ts_format.uv)
...
def test_update_wind(wind_circ):
    ...
    # update wind timeseries - default ts_format is magnitude_direction
    ...
    o_wind.set_timeseries(t_dtv, units='meters per second', ts_format=basic_types.ts_format.uv)
...
def _get_timeseries_from_cpp(windmover):
    ...
    """
    dtv = windmover.wind.get_timeseries(ts_format=basic_types.ts_format.uv)
