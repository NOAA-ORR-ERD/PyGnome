...
class Test_FlatEarthProjection:
    ...
    def test_bounds(self):
        ...
        coords = ((20.0, 50.0, 0.0), (20.0, 70.0, 0.0), (40.0, 50.0,
                  0.0), (40.0, 70.0, 0.0))
        ...
        assert np.array_equal(proj_coords, [[124, 500], [124, 0], [375,
                              500], [375, 0]])
    ...
    def test_outside(self):
        ...
        coords = ((9.9999999, 49.99999999, 0.0), (50.0000001,
                  70.000000001, 0.0))
...
def test_meters_to_lonlat():
    ...
    assert np.allclose(m2l((METERS_PER_DEGREE, METERS_PER_DEGREE_GNOME,
...
def test_meters_to_lonlat2():
    ...
    assert np.allclose(m2l((METERS_PER_DEGREE_GNOME,
                       METERS_PER_DEGREE_GNOME, 4.5), (0.0, 60.0,
                       0.0)), (2.0, 1., 4.5))
...
def test_meters_to_lonlat3():
    ...
    dlonlat = m2l((METERS_PER_DEGREE_GNOME, METERS_PER_DEGREE_GNOME,
                  0.0), (30.0, 90.0, 0.0))
...
def test_meters_to_latlon2():
    ...
    assert np.allclose(l2m((2.0, 1., 4.5), (0.0, 60.0, 0.0)),
                       (METERS_PER_DEGREE_GNOME,
                       METERS_PER_DEGREE_GNOME, 4.5))
