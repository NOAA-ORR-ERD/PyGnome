...
def test_basic_move():
    ...
    sp = TestSpillContainer(num_elements=5)
...
def test_north():
    sp = TestSpillContainer(num_elements=10, start_pos=(20, 0.0, 0.0))
...
def test_uncertainty():
    sp = TestSpillContainer(num_elements=1000, start_pos=(0.0, 0.0,
                            0.0))

    u_sp = TestSpillContainer(num_elements=1000, start_pos=(0.0, 0.0,
                              0.0), uncertain=True)
