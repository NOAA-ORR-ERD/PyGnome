...
class TestGridCurrentMover():
    ...
    def test_move_reg(self):
        ...
        time_grid_file = os.path.join(cur_dir, 'test.cdf')
    ...
    def test_move_curv(self):
        ...
        time_grid_file = os.path.join(cur_dir, 'ny_cg.nc')
        topology_file = os.path.join(cur_dir, r'NYTopology.dat')
    ...
    def test_move_curv_series(self):
        ...
        time_grid_file = os.path.join(cur_series_dir, 'flist2.txt')
        topology_file = os.path.join(cur_series_dir, 'HiROMSTopology.dat')
    ...
    def test_move_tri(self):
        ...
        time_grid_file = os.path.join(cur_dir, 'ChesBay.nc')
        topology_file = os.path.join(cur_dir, 'ChesBay.dat')
    ...
    def test_move_ptcur(self):
        ...
        time_grid_file = os.path.join(cur_dir, 'ptCurNoMap.cur')
        topology_file = r""
    ...
    def test_move_gridcurtime(self):
        ...
        time_grid_file = os.path.join(cur_dir, 'gridcur_ts.cur')
        topology_file = r""
    ...
    def test_move_gridcur_series(self):
        ...
        time_grid_file = os.path.join(cur_dir, 'gridcur_ts_hdr2.cur')
        topology_file = r""
