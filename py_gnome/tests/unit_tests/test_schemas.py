...
@pytest.mark.parametrize("filename",
                         [os.path.join(tides_dir, "CLISShio.txt"),
                          os.path.join(tides_dir, "TideHdr.FINAL")]
                         )
...
def test_catsmover_update():
    ...
    td_file = os.path.join(lis_dir, "CLISShio.txt")
    ...
    # now let's say we want to update the Tide object, which is
