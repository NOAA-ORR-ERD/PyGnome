...
def make_model(images_dir=os.path.join(base_dir, 'images')):
    ...
    model = gnome.model.Model(start_time=start_time,
                              ...
                              time_step=900, uncertain=False)  # years worth of data in file
    ...
    model.map = gnome.map.MapFromBNA(mapfile, refloat_halflife=1)  # hours
    ...
    w_mover = gnome.movers.WindMover(Wind(timeseries=series,
            units='knots'))
