# -*- coding: utf-8 -*-
#
# pyGNOME documentation build configuration file, created by
...
#              'sphinx.ext.imgmath',
              'sphinx.ext.mathjax',
              'sphinx.ext.viewcode',
# autosectionlabel resulted in lots of duplicate labels
...
exclude_patterns = ['_build','**.ipynb_checkpoints','exclude_dir']
...
# of the sidebar.
html_logo = "graphics/GNOME_logo_225px-wide.png"
