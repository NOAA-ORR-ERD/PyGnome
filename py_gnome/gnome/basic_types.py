...
world_point = numpy.dtype([('p_long', world_point_type),
                           ...
                           align=True)
world_point_3d = numpy.dtype([('p', world_point),
                              ('z', numpy.float64)],
                             align=True)

world_rect = numpy.dtype([('lo_long', numpy.long),
                          ('lo_lat', numpy.long),
                          ('hi_long', numpy.long),
                          ('hi_lat', numpy.long)],
                         align=True)
...
windage_type = numpy.float64

wind_uncertain_rec = numpy.dtype([('randCos', numpy.float32), ('randSin', numpy.float32),], align=True)
le_uncertain_rec = numpy.dtype([('downStream', numpy.float32), ('crossStream', numpy.float32),], align=True)
...
disp_status_have_removed = wind_mover.disp_status_have_removed
