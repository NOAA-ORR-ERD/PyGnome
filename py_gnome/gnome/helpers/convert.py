...
def to_time_value_pair(datetime_value_2d, in_data_format):
    ...
    time_value_pair = np.zeros((len(datetime_value_2d),), dtype=basic_types.time_value_pair).view(dtype=np.recarray)
...
def to_datetime_value_2d(time_value_pair, out_data_format):
    ...
    datetime_value_2d = np.zeros((len(time_value_pair),), dtype=basic_types.datetime_value_2d).view(dtype=np.recarray)
