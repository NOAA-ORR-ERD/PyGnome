...
caveat = ("This trajectory was produced by GNOME "
          ...
          "not for a real response. In the event of an oil or chemical spill "
          "in U.S. waters, contact the U.S. Coast Guard National "
...
def build_one_timestep(floating_positions,
    ...
    for status, positions in [('Floating', floating_positions),
        ...
        if status == "Floating":
            data['style'] = "#" + color + "DotIcon"
        else:
            data['style'] = "#" + color + "XIcon"
