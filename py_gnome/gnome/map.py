...
#            p['p_lat'] = lwp['p_lat'] + displacement[1]
    ...
    def beach_elements(self, start_positions, end_positions):
        ...
        : returns last_water_positions, beached_flags : 
        
        """
        
        # project the positions:
        start_positions = self.projection.to_pixel(start_positions)
        end_positions   = self.projection.to_pixel(end_positions)
