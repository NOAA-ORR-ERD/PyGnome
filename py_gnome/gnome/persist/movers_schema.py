...
from colander import SchemaNode, MappingSchema, Bool, Float, String, \
    TupleSchema, drop
...
class Mover(MappingSchema):
    ...
    active_start = SchemaNode(LocalDateTime(), default=None,
                              missing=drop,
                              validator=convertible_to_seconds)
    active_stop = SchemaNode(LocalDateTime(), default=None,
                             missing=drop,
                             validator=convertible_to_seconds)
