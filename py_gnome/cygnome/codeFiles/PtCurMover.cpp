...
OSErr PtCurMover::AddUncertainty(long setIndex, long leIndex,VelocityRec *velocity,double timeStep,Boolean useEddyUncertainty)
{
...
void PtCurMover::ModelStepIsDone()
{
	fIsOptimizedForStep = false;
}
...
void PtCurMover::DisposeLoadedData(LoadedData *dataPtr)
{
	if(dataPtr -> dataHdl) DisposeHandle((Handle) dataPtr -> dataHdl);
	ClearLoadedData(dataPtr);
}

void PtCurMover::ClearLoadedData(LoadedData *dataPtr)
{
	dataPtr -> dataHdl = 0;
	dataPtr -> timeIndex = UNASSIGNEDINDEX;
}

long PtCurMover::GetNumTimesInFile()
{
	long numTimes = 0;
...
long PtCurMover::GetNumDepths(void)
{
	long numDepths = 0;
...
VelocityRec PtCurMover::GetScaledPatValue(WorldPoint p,Boolean * useEddyUncertainty)
{
	VelocityRec v = {0,0};
...
VelocityRec PtCurMover::GetPatValue(WorldPoint p)
{
	VelocityRec v = {0,0};
...
void PtCurMover::GetDepthIndices(long ptIndex, float depthAtPoint, long *depthIndex1, long *depthIndex2)
{
