...
#ifndef __IceWindMover_c__
#define __IceWindMover_c__
...
class DLL_API IceWindMover_c : virtual public GridWindMover_c {
...
#ifndef pyGNOME
	IceWindMover_c (TMap *owner, char *name);
#endif
	IceWindMover_c (); 
	virtual ~IceWindMover_c () { Dispose (); }
	virtual void		Dispose ();
	
	//virtual ClassID 	GetClassID () { return TYPE_ICEWINDMOVER; }
	//virtual Boolean	IAm(ClassID id) { if(id==TYPE_ICEWINDMOVER) return TRUE; return GridWindMover_c::IAm(id); }
